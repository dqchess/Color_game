...
public class LevelManager : MonoBehaviour
{
    ...
    public string GetCountryDescriptionForLevel(int level)
    {
        switch (level)
        {
            ...
            case 7: return "In 2013, the collapse of Rana Plaza, a complex housing a number of garment factories near Dhaka, Bangladesh made worldwide headlines when over 1,000 factory workers were crushed to death and another 2,500 workers injured";
            ...
            case 48: return "Pakistan is the world’s first Islamic country to attain nuclear power. Pakistan has the largest canal-based irrigation system in the world. Pakistan has the world’s largest ambulance network. Pakistan’s Edhi Foundation, which is also listed in the Guinness Book of World Records, operates the network";

            case 49:
                return "Sana’a is the capital and largest city Yemen. It is one of the oldest continuously inhabited cities in the world. At an elevation of 2300 metres(7, 500 ft), it is also one of the highest capital cities in the world. Yemen’s territory includes more than 200 islands";
            ...
            case 52: return "Qatar’s per capita GDP is $127,600, according to the International Monetary Fund. That’s some way ahead of Luxembourg, in second place, with $104,003. Having the world's third-largest natural-gas reserves and oil reserves, despite being geographically smaller than Yorkshire, certainly helps";
            ...
            case 62:
                return "Palau is a beautiful tropical paradise, and one of the true unspoiled destinations on the planet. Geographically, the terrain varies from the high, mountainous main island of Babeldaob to low coral islands usually fringed by large barrier reefs";
